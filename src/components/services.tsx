      ...
      <style>{`
        ...
        .svc2-mob {
          /* Диаметр ограничен и шириной, и высотой. Только 90vw давало круг,
             ...
             Коэффициенты подняты на 3% (было 90vw / 42svh): круг стал чуть
             крупнее, чтобы дать больше места тексту. Оба слагаемых подняты
             одинаково, чтобы прибавка не зависела от того, какое из них
             сработало. Выше 93.7vw поднимать нельзя: пунктирное кольцо —
             это диаметр × 1.0667, и на 93.75vw оно ровно упирается в края
             экрана. */
          --svc2-mob-d: min(92.7vw, 43.3svh);  /* активный круг */
        ...
        /* Тесный экран (360×700 и подобные) — то же условие, что у блока
           ...
           с ним. */
        html[data-vp="tight"] .svc2-mob { --svc2-mob-d: min(93.5vw, 45.4svh); }
